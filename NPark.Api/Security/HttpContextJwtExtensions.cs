...
namespace NPark.Api.Security
{
    public static class HttpContextJwtExtensions
    {
        ...
        public static Guid? GetGateId(this ClaimsPrincipal user, ITokenReader reader)
            => reader.TryGet<Guid>(user, JwtClaimTypesCustom.GateId).value;
